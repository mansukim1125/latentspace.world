...
const profileObj: IProfile = {
  ...
  summary: "8년차 백엔드 개발자로 대규모 커머스 플랫폼 설계와 구현에 전문성을 갖고 있습니다. 마이크로서비스 아키텍처 구축 및 최적화에 깊은 경험이 있으며, 대용량 트래픽 처리와 분산 시스템 설계를 통해 안정적인 서비스 운영에 기여해왔습니다. 새로운 기술 트렌드를 탐구하는 것을 즐기며, 복잡한 문제를 효율적으로 해결하는 것에 열정을 가지고 있습니다.",
  location: "서울, 대한민국",
  experience: "8+ years",
