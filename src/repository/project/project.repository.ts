...
const projects: IProject[] = [
  {
    ...
    achievements: [
      '300만 DAU 트래픽 처리를 위한 SQS 기반 대용량 메시지 시스템 구축',
    ...
    content: '## 작업 내용\n' +
      ...
      '4. **구독 Worker 재시작**: 최종적으로 새로운 유저들이 채널을 구독할 수 있도록 임시 Queue를 Worker 서버와 연결하여 구독 처리합니다.\n' +
      '    1. 임시 Queue 에 쌓여 있던 구독 요청이 해소되면서 채널 구독이 진행됨\n' +
      '\n' +
      '### **사업적인 방향성을 고려한 설계**\n' +
      '\n' +
      '- 초기 기획은 “캐시워크 공식 채널” 로, 캐시워크 ***내부 서비스에 대한 홍보 채널로써의 기능***만을 하는 기획이었습니다.\n' +
      '- 하지만, PM 님과 소통하면서 해당 기능은 캐시워크 내부에서만 사용되는 것이 아니라 ***외부 업체와의 계약을 통한 홍보 매체로 활용***될 수 있는 기능이라는 결론을 내렸고\n' +
      '- 이에 따라 신규 채널을 개설하면 캐시워크 for Business 채널 기능을 활성화할 수 있도록 하는 인터페이스를 미리 개발할 수 있었습니다.\n' +
      '\n' +
      '## 아쉬웠던 점 및 향후 방향\n' +
      '\n' +
      '### 로깅을 조금 더 꼼꼼히 남길 걸..\n' +
      '\n' +
      '- "메시지 전송 도중에 문제가 발생할 수 있는 지점에 로그를 심어둘 걸" 하는 아쉬움이 남았습니다.\n' +
      '- 일반 메시지 전송 시 현재 전송중인 채널 채팅방 ID를 로깅하여 개발 단에서 확인하고 문제 발생 시 즉각적으로 대응할 수 있도록 개발했어야 한다고 생각이 들었습니다.\n' +
      '  - 특히 외부 업체와의 계약으로 채널을 개설하고 메시지를 발송하는 경우 이러한 부분이 더욱 중요할 것입니다.\n' +
      '  - (문제 발생 시 언제든지 메시지 발송을 중단할 수 있는 메커니즘이 필요하지 않았을까?)'
  },
  {
  ...
  {
    id: 'websocket-chat-incident',
    title: '대용량 채팅 시스템의 연쇄 장애 해결: 복합적 원인 추적과 해결 과정',
    slug: 'websocket-chat-incident',
    excerpt: '복잡한 채팅 인프라에서 발생한 장애의 근본 원인 발견부터 다층적 해결까지의 기술적 여정',
    category: '장애 대응',
    ...
    content:
      ...
      '\n' +
      '- **서버 구조**: 로드 밸런서 뒤에 여러 EC2 인스턴스가 배포된 scale-out 가능한 서버 구조\n' +
      ...
      '\n' +
      '## 1주일 풀-야근의 시작: 대규모 채팅 시스템(메신저)의 장애 근본 원인 분석\n' +
      '\n' +
      ...
      '2. **분산된 인프라 환경에서의 복잡한 상호작용**: Socket.io Redis Adapter의 동작 방식과 Redis PubSub 메커니즘 간의 상호작용을 심층적으로 이해해야 했습니다.\n' +
      '\n' +
      '## 심층 분석 및 근본 원인 발견\n' +
      '\n' +
      ...
      '\n' +
      '1. **Scale-out 되어 있는 서버 인스턴스의 PubSub 메커니즘**\n' +
      ...
      '### 복잡한 대규모 시스템 디버깅 역량 향상\n' +
      '\n' +
      '이 경험을 통해 여러 구성 요소가 상호작용하는 복잡한 대규모 시스템 구조에서 발생한 문제를 해결하는 접근 방식을 배울 수 있었습니다.\n' +
      '\n' +
      ...
      '   - Socket.io Redis Adapter의 내부 동작 원리(분산된 환경에서의 PubSub 메커니즘)를 심층적으로 이해하게 되었고, 장애 발생 원인을 찾아낼 수 있었습니다.\n' +
      '\n' +
      ...
      '## 결론\n' +
      '\n' +
      '이번 장애 대응 경험은 채팅 시스템(메신저)의 장애 상황에서 표면적 증상으로부터 시작해 여러 구성요소를 탐색하고,\n' +
      '\n' +
      '최종적으로 근본 원인을 발견하여 해결하는 과정이었습니다. (CTO 님과 지코바를 먹으며..)\n' +
      '\n' +
      '이러한 경험을 통해 복잡한 구조를 가진 시스템에서의 장애 대응 방법과 복잡한 인과관계를 추적하는 능력을 크게 향상시킬 수 있었습니다.\n' +
      '\n' +
  ...
  },
  {
    ...
    content:
      ...
      '\n' +
      '이는 사용자 증가로 인한 CPU 사용률, 네트워크 트래픽, 그리고 데이터베이스 쿼리 증가로 인한 것이었습니다.\n' +
      '\n' +
      '## 문제 발견 및 원인 분석\n' +
      '\n' +
      '### 문제 징후\n' +
  ...
  },
  {
    ...
    "content":
      ...
      '   - 쿼터 제한을 완화하기 위해서는 적절한 캐싱 전략을 도입해야 한다는 것을 배웠습니다.\n' +
